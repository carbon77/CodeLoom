...
public class PeakMemoryUsageCallback
    extends ResultCallbackTemplate<PeakMemoryUsageCallback, Statistics> {
  ...
  public void onNext(Statistics s) {
    ...
    Long cache =
        s.getMemoryStats().getStats() == null ? null : s.getMemoryStats().getStats().getCache();
