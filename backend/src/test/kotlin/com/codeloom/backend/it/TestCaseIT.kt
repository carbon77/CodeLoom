...
class TestCaseIT {
    ...
    inner class FindOne {
        ...
        fun `should return 404 for non-existing id`() {
            mockMvc
                .get("/v1/testCases/${UUID.randomUUID()}")
                .andExpect {
                    status { isNotFound() }
                }
        }
    ...
    inner class FindByProblemId {
        ...
        fun `should return only public test cases by default`() {
            ...
            mockMvc
                .get("/v1/testCases/by-problem-id/${problem.id}")
                .andExpect {
                    status { isOk() }
    ...
    inner class Patch {
        ...
        fun `should patch test case`() {
            ...
            mockMvc
                .patch("/v1/testCases/${testCase.id}") {
                    contentType = MediaType.APPLICATION_JSON
                    content =
                        """
                        {
    ...
    inner class Delete {
        ...
        fun `should delete test case`() {
            ...
            mockMvc
                .delete("/v1/testCases/${testCase.id}")
                .andExpect {
                    status { isOk() }
                }
